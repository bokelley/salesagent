...
def mock_all_external_dependencies():
    ...
    mock_first_result.tenant_id = "default"  # str — base.html subnav concatenates with prefix
    mock_first_result.embed_breadcrumb_root = None  # resolve_embed_breadcrumb_root rejects MagicMock
